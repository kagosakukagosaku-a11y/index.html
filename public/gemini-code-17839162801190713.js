(function() {
    ...
    secretPetal.style.boxShadow = '0 4px 10px rgba(255,182,193,0.8)';
    ...
    adminPanel.innerHTML = `
        ...
        <p style="margin: 10px 0 5px 0; font-size: 12px; color: #555; font-weight: bold;">📢 「確認ボタン」の状況を設定</p>
    ...
    document.getElementById('btn-break').addEventListener('click', () => setStatus('ただいま【休憩中】です。', '#17a2b8'));
    document.getElementById('btn-busy').addEventListener('click', () => setStatus('ただいま【混雑】しています。', '#dc3545'));
    document.getElementById('btn-closed').addEventListener('click', () => setStatus('本日は【休診】です。', '#6c757d'));

    // 4. 画面上の「受付状況を確認する」ボタンを見つけて連動させる
